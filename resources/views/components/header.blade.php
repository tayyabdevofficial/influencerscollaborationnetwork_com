...
<header class="sticky top-0 z-40 w-full transition-colors duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20 gap-2">
                ...
                <div class="hidden lg:flex items-center gap-1 xl:gap-2 overflow-visible">
                    <a href="{{ route('home') }}" 
                       class="px-3 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap {{ request()->routeIs('home') ? 'text-[#DC2626] dark:text-[#06B6D4] bg-slate-100 dark:bg-slate-800' : 'text-slate-700 dark:text-slate-300 hover:text-[#DC2626] dark:hover:text-[#06B6D4] hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                        Home
                    </a>
    ...
    <div id="mobile-nav-drawer" 
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-2">
            <a href="{{ route('home') }}" 
               onclick="window.closeMobileNav()"
               class="block px-3.5 py-2.5 rounded-xl font-bold text-sm text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                Home
            </a>
